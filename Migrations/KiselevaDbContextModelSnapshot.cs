...
namespace kiseleva_nastia_42_21.Migrations
{
    ...
    partial class KiselevaDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kiseleva_nastia_42_21.Models.EducationalSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("kiseleva_nastia_42_21.Models.Professor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("kiseleva_nastia_42_21.Models.Workload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("kiseleva_nastia_42_21.Models.Workload", b =>
                {
                    b.HasOne("kiseleva_nastia_42_21.Models.EducationalSubject", "EducationalSubject")
                        .WithMany()
                    ...
                    b.HasOne("kiseleva_nastia_42_21.Models.Professor", "Professor")
                        .WithMany()
